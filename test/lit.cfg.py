...
config.substitutions.append(('%cargo-stylus', 'cargo stylus'))
...
if os.path.exists(venv_wrapper):
    config.substitutions.append(('cargo-stylus-venv', f'{venv_wrapper} cargo stylus'))
else:
    config.substitutions.append(('cargo-stylus-venv', 'cargo stylus'))
